...
function ClassrHostLL() {
  ...
  function hasAllKeys(obj) {
    const requiredKeys = [
      ...
      "sessionStructure", "studentsWho", "requirements",  "img"
    ];

    if (!obj.img || obj.img.length < 1) {
      return false
    }
  ...
  async function nava() {
    ...
    const res = await axios.post(BaseUrl + `/classroom/sessionInfo`,
      { ...data },
      {
  ...
  return (
    <>
      ...
      <div className="tabs-container mt-4">
        ...
        >
          <StyledTab label="Session Information" className={activeTab === 0 ? 'klout' : ''} />
          <StyledTab label="Trainer Information" className={activeTab === 1 ? 'klout' : ''} />
