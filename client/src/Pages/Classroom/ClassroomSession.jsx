...
const JoinTheSession = () => {
    ...
    useEffect(() => {
        async function getter() {
            ...
            console.log(data)
            const res = await axios.get(BaseUrl + `/classroomv2/sessionInfo?id=${id}`,
                {
                    params: data,
                    headers: { Authorization: `Bearer ${authTokens}` }
                });
    ...
    const checkBeforeJoining = async () => {
        const bool = checkIfEventIsAboutToEnd(currentClass.date[0])
        if (bool){
            dono(`/classroomv2/meet/${currentClass.ClassroomId}/${currentClass.id}`)
        }else{
            alert('The Session is not started yet.')
        }
    };
                ...
                <div className="CPr2Banner" ref={divRef}>
                    <div className="CPR2BInfo">
                        ...
                        <div className="CPR2Auth" >
                            ...
                            <span className="CPR2AuthName gm"> {currentClass && currentClass.trainerBio && `${currentClass.trainerBio}`} </span>
                        </div>
                        ...
                        <div className="CPR2Timing">
                            ...
                            <span className="CPR2TimingL">
                                ...
                                <span className="d gm">{currentClass && currentClass.languageOfClass
                                }</span>
                            </span>
                    ...
                    <div className="CPR2BImage">
                        ...
                        <div className="mt-3"> 
                            <button className="buyNowInTabs gm">
                                <AccessTime/>
                            </button>
                        </div>
                ...
                <div className="Claser mt-5">
                    <div>
                        ...
                        <span className="VFDTitle gm w-80 d-block ljdojasy">
                            <span dangerouslySetInnerHTML={{ __html: currentClass ? currentClass.sessionStructure : '' }}>
