                                            ...
                                            <div className="bannersForHomePage">
                                                ...
                                                <div className="carousel1">
                                                    <Carousel
                                                        ...
                                                        infinite={true}
                                                    >
                                                        {/* <div className="carousel-itemingkksk">Item 1</div>
                                                    <div className="carousel-itemingkksk">Item 2</div>
                                                    <div className="carousel-itemingkksk">Item 3</div>
                                                    <div className="carousel-itemingkksk">Item 4</div>
                                                    <div className="carousel-itemingkksk">Item 5</div>
                                                    <div className="carousel-itemingkksk">Item 6</div> */}
