...
import newChatIC from "../../Images/newChat.svg"
        ...
        <>
            <div className="panel">
                <div className="nameDivOnTop">
                    ...
                    {/* <newChat onClick={() => setNewChat(true)} className="newChatIcon cp" /> */}
                    <img src={newChatIC} alt="not loaded  " onClick={() => setNewChat(true)} className="newChatIcon cp"/>
                    {/* <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" fill="#495656f0">
                 ...
                 <div className="titleDiv">
                    <div className={!showRequest ? "title selectedPanelOnTheChat fmfont" : "title fmfont cp"} onClick={() => clickedOnReqss(false)}>
                        CHATS
                    </div>
                    <div className={!showRequest ? "messageRequestsMode fmfont cp" : "messageRequestsMode selectedPanelOnTheChat fmfont"} onClick={() => clickedOnReqss(true)}>
                        Requests
                    </div>
                </div>
                ...
                <div className="newMessageDivListing">
                    ...
                    <div className="turnTheNameNewMess">
                        ...
                        <div className="searchingName">
                            <input type="text" className="fmfont" placeholder="Search..." value={search} onChange={(e) => setSearch(e.target.value)} />
                        </div>
                    </div>
